...
import { isWebpackBundledLayer, isWebpackClientOnlyLayer, shouldUseReactServerCondition, isWebpackDefaultLayer, RSPACK_DEFAULT_LAYERS_REGEX } from './utils';
...
function getReactRefreshLoader() {
    return process.env.NEXT_RSPACK ? getRspackReactRefresh().loader : require.resolve(reactRefreshLoaderName);
}
...
export function getCacheDirectories(configs) {
...
export default async function getBaseWebpackConfig(dir, { buildId, encryptionKey, config, compilerType, dev = false, entrypoints, isDevFallback = false, pagesDir, reactProductionProfiling = false, rewrites, originalRewrites, originalRedirects, runWebpackSpan, appDir, middlewareMatchers, noMangling, jsConfig, jsConfigPath, resolvedBaseUrl, supportedBrowsers, clientRouterFilters, fetchCacheKeyPrefix, isCompileMode, previewProps }) {
    var _config_experimental, _config_experimental1, _config_compiler, _config_compiler1, _config_compiler2, _jsConfig_compilerOptions, _config_compiler3, _jsConfig_compilerOptions1, _config_compiler4, _config_experimental2, _config_watchOptions, _config_experimental_sri, _config_experimental_sri1, _jsConfig_compilerOptions2, // always add JsConfigPathsPlugin to allow hot-reloading
    // if the config is added/removed
    _webpackConfig_resolve_plugins, _webpackConfig_resolve, _config_experimental3, _config_compiler5, _config_compiler6, _config_compiler7, _config_compiler8, _config_compiler9, _webpack5Config_plugins, _webpackConfig_module, _webpackConfig_module1, _webpackConfig_module_rules, _webpackConfig_module2;
    ...
    let webpackConfig = {
        ...
        optimization: {
            ...
            */ const extractRootNodeModule = (modulePath)=>{
            ...
            minimizer: [
                // Minify JavaScript
                isRspack ? new (getRspackCore()).SwcJsMinimizerRspackPlugin({
                ...
                isRspack && (process.env.__NEXT_TEST_MODE ? config.experimental.useLightningcss : ((_config_experimental2 = config.experimental) == null ? void 0 : _config_experimental2.useLightningcss) === undefined || config.experimental.useLightningcss) ? new (getRspackCore()).LightningCssMinimizerRspackPlugin({
        ...
        plugins: [
            ...
            dev && isClient && (isRspack ? new (getRspackReactRefresh())({
                injectLoader: false,
                injectEntry: false,
                overlay: false
            ...
            new (getWebpackBundler()).DefinePlugin(getDefineEnv({
                isTurbopack: false,
                config,
                dev,
                distDir,
            ...
            !dev && isClient && config.experimental.cssChunking && (isRspack ? new (getRspackCore()).experiments.CssChunkingPlugin({
    ...
    const configVars = JSON.stringify({
        optimizePackageImports: config == null ? void 0 : (_config_experimental3 = config.experimental) == null ? void 0 : _config_experimental3.optimizePackageImports,
    ...
    const cache = {
        ...
        version: `${__dirname}|${"15.4.2"}|${configVars}`,
