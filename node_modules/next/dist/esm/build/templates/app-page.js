...
import { RSC_HEADER, NEXT_ROUTER_PREFETCH_HEADER, NEXT_IS_PRERENDER_HEADER, NEXT_DID_POSTPONE_HEADER } from '../../client/components/app-router-headers';
...
export async function handler(req, res, ctx) {
   ...
   * prefetch request.
   */ const isPrefetchRSCRequest = getRequestMeta(req, 'isPrefetchRSCRequest') ?? Boolean(req.headers[NEXT_ROUTER_PREFETCH_HEADER]);
