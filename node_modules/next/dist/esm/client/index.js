...
class Container extends React.Component {
    ...
    render() {
        if (process.env.NODE_ENV === 'production') {
            ...
            const { PagesDevOverlayBridge } = require('../next-devtools/userspace/pages/pages-dev-overlay-setup');
            return /*#__PURE__*/ _jsx(PagesDevOverlayBridge, {
...
export async function hydrate(opts) {
    ...
    if (process.env.NODE_ENV === 'development') {
        const getServerError = require('../server/dev/node-stack-frames').getServerError;
