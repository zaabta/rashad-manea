...
var RouteType = /*#__PURE__*/ function(RouteType) {
    /**
...
function warnAboutTurbopackBuilds(config) {
    ...
    warningStr += '\n\n- ' + (0, _picocolors.bold)('Turbopack currently always builds production source maps for the browser. This will include project source code if deployed to production.');
