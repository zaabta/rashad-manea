    ...
    <section id="about" className="py-20 bg-gray-50 dark:bg-gray-800/50">
      <div className="container-max-width section-padding">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold">{t('ui.executiveSummary')}</h3>
              </div>
            ...
            {/* Fun Facts */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-semibold mb-6">{t('ui.strengths')}</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-primary-50 dark:bg-primary-900/20 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t('ui.trained')}</p>
                </div>
                <div className="text-center p-4 bg-accent-50 dark:bg-accent-900/20 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t('ui.reports')}</p>
                </div>
                <div className="text-center p-4 bg-primary-50 dark:bg-primary-900/20 rounded-xl">
                  <Heart className="text-red-500 mx-auto mb-2" size={32} />
                  <p className="font-semibold text-2xl text-red-500">∞</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t('ui.experienceYears')}</p>
                </div>
                <div className="text-center p-4 bg-accent-50 dark:bg-accent-900/20 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t('ui.internationalCompliance')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-semibold mb-6">{t('ui.credentials')}</h3>
              <div className="space-y-6">
                {education.map((edu) => (
                  <div key={edu.id} className="border-r-4 border-primary-400 pr-6 pb-6 last:pb-0">
                    ...
                    {edu.gpa && <p className="text-sm text-gray-600 dark:text-gray-400">{t('ui.grade')}: {edu.gpa}</p>}
                    {edu.description && (
            ...
            {/* What I Do */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-semibold mb-6">{t('ui.excellence')}</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">{t('ui.highlightSystems')}</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {t('ui.highlightSystemsText')}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">{t('ui.highlightHospitals')}</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {t('ui.highlightHospitalsText')}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">{t('ui.highlightTraining')}</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {t('ui.highlightTrainingText')}
                    </p>
                  </div>
                </div>
              </div>
